...
def InsertEntries(cursor:psycopg2.extensions.cursor,table:str,data_list:list[dict[str,Any]]) -> None:
    """
...
def DeleteEntries(cursor:psycopg2.extensions.cursor,table:str,filter:dict[str,Any]=None) -> None:
    """
...
def GetEntries(cursor:psycopg2.extensions.cursor,table:str,columns:str='*',filter:dict[str,Any]=None) -> list[dict[str, Any]]:
    """
